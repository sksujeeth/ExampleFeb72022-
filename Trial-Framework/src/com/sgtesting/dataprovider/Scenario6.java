...
private static WebDriver driver=null;
	...
	{
		return new Object[][] {{"USL","Bewerages"}};
	}
	...
	{
		return new Object[][] {{"Spirits","manufacturing"}};
	}
	@Test(priority = 5,dataProvider = "modifyproj")
	private static void modifyproject(String projdesc)
	{
		try
		{
			driver.findElement(By.xpath("/html/body/div[10]/div[1]/div[2]/div[2]/div/div[2]/div/div[1]/div[2]/div[3]/div[3]")).click();
			Thread.sleep(2000);
			driver.findElement(By.xpath("/html/body/div[10]/div[2]/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).clear();
			Thread.sleep(2000);
			driver.findElement(By.xpath("/html/body/div[10]/div[2]/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys(projdesc);
			Thread.sleep(2000);
			driver.findElement(By.xpath("/html/body/div[10]/div[2]/div[4]/div[1]/div[1]")).click();
			Thread.sleep(2000);   
		} catch (Exception e) 
		{
			e.printStackTrace();
